[greonproject-4ce8] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [greonproject-4ce8] container is NOT running**.

.. tip::
   You must have your [greonproject-4ce8] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Greon101/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Greon101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=45681  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='Greon101'  \-\-env DOCKERUSERNAME='greon101'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
[greonproject-4ce8] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Greon101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/greonproject-4ce8
...
.. important::
   solution_preprocessing_ai_mqtt_dag-greonproject-4ce8
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=51395, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39829, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36427, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=32791, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=33501, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41127, HPDEHOST=127.0.1.1, HPDEPORT=37211, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46817

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6676-greonproject-4ce8,solution_preprocessing_ai_mqtt_dag-greonproject-4ce8, python-preprocess-1474-greonproject-4ce8,solution_preprocessing_ai_mqtt_dag-greonproject-4ce8, python-ai-3530-greonproject-4ce8,solution_preprocessing_ai_mqtt_dag-greonproject-4ce8, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
